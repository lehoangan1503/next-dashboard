            ...
            {invoices?.map((invoice) => (
              <div key={invoice.id} className="mb-2 w-full rounded-md bg-white p-4">
                ...
                <div className="flex w-full items-center justify-between pt-4">
                  <div>
                    <p className="text-xl font-medium">{formatCurrency(Number(invoice.amount))}</p>
            ...
            <tbody className="bg-white">
              {invoices?.map((invoice) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3">{formatCurrency(Number(invoice.amount))}</td>
